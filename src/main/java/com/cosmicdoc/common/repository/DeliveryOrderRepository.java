...
public interface DeliveryOrderRepository  {
     ...
     */
    Optional<DeliveryOrder> findByOrderIdAndOrganizationIdAndBranchId(String orderId, String organizationId, String branchId);
     ...
     */
    List<DeliveryOrder> findByOrganizationIdAndBranchIdAndStatus(String organizationId, String branchId, DeliveryStatus status);
    ...
    List<DeliveryOrder> findByOrganizationIdAndBranchId(String orgId,String BranchId);
